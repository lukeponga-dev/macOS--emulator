...
export function BootSequence({ machine, onComplete }: BootSequenceProps) {
  ...
  return (
    <div className="flex-1 bg-black flex flex-col items-center justify-center p-4 text-center">
      {/* Apple Logo */}
      <div className="mb-8">
        <svg className="w-20 h-24 sm:w-24 sm:h-28 text-white" viewBox="0 0 170 170" fill="currentColor">
      ...
      {/* Progress Bar */}
      <div className="w-full max-w-xs h-1.5 bg-neutral-800 rounded-full overflow-hidden mb-4">
        <div
