...
export function BootSequence({ machine, onComplete }: BootSequenceProps) {
  ...
  return (
    <div className="flex-1 bg-black flex flex-col items-center justify-center p-4 sm:p-8 md:p-12">
      {/* Apple Logo */}
      <div className="mb-6 sm:mb-8">
        <svg className="w-16 h-20 sm:w-20 sm:h-24 md:w-24 md:h-28 text-white" viewBox="0 0 170 170" fill="currentColor">
      ...
      {/* Progress Bar */}
      <div className="w-3/4 max-w-xs h-1 sm:h-1.5 md:h-2 bg-neutral-800 rounded-full overflow-hidden mb-3 sm:mb-4">
        <div
      ...
      {/* Boot Message */}
      <p className="text-neutral-500 text-xs sm:text-sm md:text-base font-mono text-center px-4">
        {bootMessages[currentMessage]}
      </p>

      {/* Machine Info */}
      <div className="absolute bottom-4 sm:bottom-8 text-neutral-600 text-xs sm:text-sm md:text-base text-center px-4">
        <p>
